//
//  DBNewServerViewController.m
//  ConnectDisk
//
//  Created by Stian Aurdal.
//

#import "DBNewServerViewController.h"
...
@interface DBNewServerViewController ()
{
    UILabel *_serverUrl;
    UILabel *_userName;
    UILabel *_password;
...
@implementation DBNewServerViewController
...
-(id)init
{
    self=[super init];
    if(self){
        self.title=NSLocalizedString(@"Connect to ownCloud",@"");
...
-(void)finishEditServer{
    // 判断必填项是否存在
    NSString *_ServerUrlPrefix = @"";
    NSString *_serverUrlString=[_ServerUrlPrefix stringByAppendingString:[_serverUrlText.text stringByAppendingString:@"/remote.php/webdav/"]];
