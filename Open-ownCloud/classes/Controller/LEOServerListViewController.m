...
//    _serverListView.bounces=NO;
    ...
    if (_serverListArray == nil || [_serverListArray count] == 0) {
        DBNewServerViewController *newServer=[[DBNewServerViewController alloc] init];
   ...
   //     [self presentViewController:viewController animated:YES completion:nil];
    [self loginServer:[_serverListArray firstObject]];
    }
...
//        [_serverListArray setObject:info atIndexedSubscript:index];
    ...
    [self loginServer:[_serverListArray lastObject]];
    return YES;
}
